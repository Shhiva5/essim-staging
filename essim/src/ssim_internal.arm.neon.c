...
void load_4x4_windows_10u_armv7(LOAD_4x4_WINDOWS_FORMAL_ARGS)
{
  ...
  for (; i + WIN_CHUNK <= num4x4Windows; i += WIN_CHUNK)
  {
    ...
    for (uint32_t y = 0; y < WIN_SIZE; ++y)
    {
      ...
      /* sum ref_sum & cmp_sum */
      r4 = vpaddlq_u16(vcombine_u16(vpadd_u16(vget_low_u16(r0), vget_high_u16(r0)), vpadd_u16(vget_low_u16(r2), vget_high_u16(r2))));
      r5 = vpaddlq_u16(vcombine_u16(vpadd_u16(vget_low_u16(r1), vget_high_u16(r1)), vpadd_u16(vget_low_u16(r3), vget_high_u16(r3))));
      r5 = vshlq_n_u32(r5, 16);
      sum = vaddq_u16(sum, vreinterpretq_u16_u32(r4));
      sum = vaddq_u16(sum, vreinterpretq_u16_u32(r5));
      ...
      r4 = vcombine_u32(vpadd_u32(vget_low_u32(vmull_u16(s0, s0)), vget_high_u32(vmull_u16(s0, s0))), vpadd_u32(vget_low_u32(vmull_u16(s1, s1)), vget_high_u32(vmull_u16(s1, s1))));
      r5 = vcombine_u32(vpadd_u32(vget_low_u32(vmull_u16(s4, s4)), vget_high_u32(vmull_u16(s4, s4))), vpadd_u32(vget_low_u32(vmull_u16(s5, s5)), vget_high_u32(vmull_u16(s5, s5))));
      r4 = vcombine_u32(vpadd_u32(vget_low_u32(r4), vget_high_u32(r4)), vpadd_u32(vget_low_u32(r5), vget_high_u32(r5)));
      ref_sigma_sqd = vaddq_u32(ref_sigma_sqd, r4);

      r4 = vcombine_u32(vpadd_u32(vget_low_u32(vmull_u16(s2, s2)), vget_high_u32(vmull_u16(s2, s2))), vpadd_u32(vget_low_u32(vmull_u16(s3, s3)), vget_high_u32(vmull_u16(s3, s3))));
      r5 = vcombine_u32(vpadd_u32(vget_low_u32(vmull_u16(s6, s6)), vget_high_u32(vmull_u16(s6, s6))), vpadd_u32(vget_low_u32(vmull_u16(s7, s7)), vget_high_u32(vmull_u16(s7, s7))));
      r4 = vcombine_u32(vpadd_u32(vget_low_u32(r4), vget_high_u32(r4)), vpadd_u32(vget_low_u32(r5), vget_high_u32(r5)));
      cmp_sigma_sqd = vaddq_u32(cmp_sigma_sqd, r4);

      r4 = vcombine_u32(vpadd_u32(vget_low_u32(vmull_u16(s0, s2)), vget_high_u32(vmull_u16(s0, s2))), vpadd_u32(vget_low_u32(vmull_u16(s1, s3)), vget_high_u32(vmull_u16(s1, s3))));
      r5 = vcombine_u32(vpadd_u32(vget_low_u32(vmull_u16(s4, s6)), vget_high_u32(vmull_u16(s4, s6))), vpadd_u32(vget_low_u32(vmull_u16(s5, s7)), vget_high_u32(vmull_u16(s5, s7))));
      r4 = vcombine_u32(vpadd_u32(vget_low_u32(r4), vget_high_u32(r4)), vpadd_u32(vget_low_u32(r5), vget_high_u32(r5)));
      sigma_both = vaddq_u32(sigma_both, r4);
...
#define ASM_LOAD_8X8_WINDOW_8_FLOAT_VALUES_armv7(value0, value1, idx)                                                       \
  {                                                                                                                         \
    uint16x8_t _r0, _r1;                                                                                                    \
    _r0 = vld1q_u16((const uint16_t *)(pSrc + (idx) * srcStride));                                                          \
    _r1 = vld1q_u16((const uint16_t *)(pSrc + (idx) * srcStride + 4));                                                      \
    ...
    _r0 = d.val[0];                                                                                                         \
    _r1 = d.val[1];                                                                                                         \
    _r0 = vcombine_u16(vpadd_u16(vget_low_u16(_r0), vget_high_u16(_r0)), vpadd_u16(vget_low_u16(_r1), vget_high_u16(_r1))); \
    uint32x4_t _r0d = vreinterpretq_u32_u16(_r0);                                                                           \
    value1 = vcvtq_f32_u32(vshrq_n_u32(_r0d, 16));                                                                          \
    _r0d = vshrq_n_u32(vshlq_n_u32(_r0d, 16), 16);                                                                          \
    value0 = vcvtq_f32_u32(_r0d);                                                                                           \
...
#define ASM_LOAD_8X8_WINDOW_4_FLOAT_VALUES_armv7(value, idx)                                                                \
  {                                                                                                                         \
    uint32x4_t _r0, _r1;                                                                                                    \
    _r0 = vld1q_u32((const uint32_t *)(pSrc + (idx) * srcStride));                                                          \
    _r1 = vld1q_u32((const uint32_t *)(pSrc + (idx) * srcStride + 4));                                                      \
    ...
    _r0 = d.val[0];                                                                                                         \
    _r1 = d.val[1];                                                                                                         \
    _r0 = vcombine_u32(vpadd_u32(vget_low_u32(_r0), vget_high_u32(_r0)), vpadd_u32(vget_low_u32(_r1), vget_high_u32(_r1))); \
    value = vmulq_f32(vcvtq_f32_u32(_r0), invWindowSize_sqd);                                                               \
  }

#define ASM_CALC_4_FLOAT_SSIM_armv7()                                         \
  {                                                                           \
    float32x4_t one = vdupq_n_f32(1);                                         \
    /* STEP 2. adjust values */                                               \
    float32x4_t both_sum_mul =                                                \
    ...
    {                                                                         \
      ...
      float32x4_t ssim_val = vmulq_f32(a, b);                                 \
      ssim_val = vaddq_f32(ssim_val, ssim_val);                               \
      ssim_val = vmulq_f32(ssim_val, vrecpeq_f32(vmulq_f32(c, d)));           \
      ssim_sum = vaddq_f32(ssim_sum, ssim_val);                               \
      ssim_val = vsubq_f32(one, ssim_val);                                    \
      if (essim_mink_value == 4)                                              \
      {                                                                       \
...
void sum_windows_8x4_float_8u_armv7(SUM_WINDOWS_FORMAL_ARGS)
{
  ...
  const float32x4_t invWindowSize_sqd = vdupq_n_f32(1.0f / (float)(windowSize * windowSize));
  const float32x4_t invWindowSize_qd = vmulq_f32(invWindowSize_sqd, invWindowSize_sqd);
  const float fC1 = get_ssim_float_constant(1, bitDepthMinus8);
  const float fC2 = get_ssim_float_constant(2, bitDepthMinus8);
  const float32x4_t C1 = vdupq_n_f32(fC1);
  const float32x4_t C2 = vdupq_n_f32(fC2);
  ...
  for (; i + WIN_CHUNK <= numWindows; i += WIN_CHUNK)
  {
    ...
    ASM_LOAD_8X8_WINDOW_8_FLOAT_VALUES_armv7(ref_sum, cmp_sum, 0);
    ASM_LOAD_8X8_WINDOW_4_FLOAT_VALUES_armv7(ref_sigma_sqd, 1);
    ASM_LOAD_8X8_WINDOW_4_FLOAT_VALUES_armv7(cmp_sigma_sqd, 2);
    ASM_LOAD_8X8_WINDOW_4_FLOAT_VALUES_armv7(sigma_both, 3);
    pSrc += sizeof(uint32_t) * WIN_CHUNK;

    ASM_CALC_4_FLOAT_SSIM_armv7();
  }

  ssim_sum = vcombine_f32(vpadd_f32(vget_low_f32(ssim_sum), vget_high_f32(ssim_sum)), vpadd_f32(vget_low_f32(ssim_mink_sum), vget_high_f32(ssim_mink_sum)));
  ssim_sum = vcombine_f32(vpadd_f32(vget_low_f32(ssim_sum), vget_high_f32(ssim_sum)), vpadd_f32(vget_low_f32(ssim_sum), vget_high_f32(ssim_sum)));
...
void sum_windows_8x8_float_8u_armv7(SUM_WINDOWS_FORMAL_ARGS)
{
  ...
  for (; i + WIN_CHUNK <= numWindows; i += WIN_CHUNK)
  {
    ...
    sum_int = vcombine_u32(vpadd_u32(vget_low_u32(sum_int), vget_high_u32(sum_int)), vpadd_u32(vget_low_u32(_r1), vget_high_u32(_r1)));
    ref_sigma_sqd_int = vcombine_u32(vpadd_u32(vget_low_u32(ref_sigma_sqd_int), vget_high_u32(ref_sigma_sqd_int)), vpadd_u32(vget_low_u32(_r2), vget_high_u32(_r2)));
    cmp_sigma_sqd_int = vcombine_u32(vpadd_u32(vget_low_u32(cmp_sigma_sqd_int), vget_high_u32(cmp_sigma_sqd_int)), vpadd_u32(vget_low_u32(_r3), vget_high_u32(_r3)));
    sigma_both_int = vcombine_u32(vpadd_u32(vget_low_u32(sigma_both_int), vget_high_u32(sigma_both_int)), vpadd_u32(vget_low_u32(_r4), vget_high_u32(_r4)));
...
{
  sum_windows_16_float_8u_armv7(SUM_WINDOWS_ACTUAL_ARGS);
}
...
void sum_windows_16_float_8u_armv7(SUM_WINDOWS_FORMAL_ARGS)
{
  ...
  for (; i + WIN_CHUNK <= numWindows; i += WIN_CHUNK)
  {
    ...
    for (uint32_t x = 0; x < 16; x += 4)
    {
      ...
      _r3 = vld1q_u32(
          (const uint32_t *)(pSrc + 3 * windowStride + x * srcStride));
      _r1 = vcombine_u32(vpadd_u32(vget_low_u32(_r0), vget_high_u32(_r0)), vpadd_u32(vget_low_u32(_r1), vget_high_u32(_r1)));
      _r3 = vcombine_u32(vpadd_u32(vget_low_u32(_r2), vget_high_u32(_r2)), vpadd_u32(vget_low_u32(_r3), vget_high_u32(_r3)));
      _r1 = vcombine_u32(vpadd_u32(vget_low_u32(_r1), vget_high_u32(_r1)), vpadd_u32(vget_low_u32(_r1), vget_high_u32(_r1)));
      ...
      _r0 = vld1q_u32((const uint32_t *)(pSrc + (x + 3) * srcStride));
      _r1 = vld1q_u32((const uint32_t *)(pSrc + windowStride + (x + 3) * srcStride));
      _r2 = vld1q_u32((const uint32_t *)(pSrc + 2 * windowStride + (x + 3) * srcStride));
      _r3 = vld1q_u32((const uint32_t *)(pSrc + 3 * windowStride + (x + 3) * srcStride));
      _r1 = vcombine_u32(vpadd_u32(vget_low_u32(_r0), vget_high_u32(_r0)), vpadd_u32(vget_low_u32(_r1), vget_high_u32(_r1)));
      _r3 = vcombine_u32(vpadd_u32(vget_low_u32(_r2), vget_high_u32(_r2)), vpadd_u32(vget_low_u32(_r3), vget_high_u32(_r3)));
      _r1 = vcombine_u32(vpadd_u32(vget_low_u32(_r1), vget_high_u32(_r1)), vpadd_u32(vget_low_u32(_r1), vget_high_u32(_r1)));
...
#define calc_window_ssim_int_8u_armv7()                                          \
  {                                                                              \
    /* STEP 2. adjust values */                                                  \
    _r0 = vbicq_u32(sum, fullMSB);                                               \
    _r1 = vshrq_n_u32(sum, 16);                                                  \
    ...
    {                                                                            \
      ...
      _r = vmull_s32(vreinterpret_s32_u32(vget_low_u32(a)), vget_low_s32(b));    \
      vst1q_s64(num + 0, _r);                                                    \
      _r = vmull_s32(vget_high_s32(vreinterpretq_s32_u32(a)), vget_high_s32(b)); \
      vst1q_s64(num + 2, _r);                                                    \
    }                                                                            \
    /* process denominators */                                                   \
    {                                                                            \
      ...
      _r = vreinterpretq_s64_u64(vmull_u32(vget_low_u32(c), vget_low_u32(d)));   \
      vst1q_s64(denom + 0, _r);                                                  \
      _r = vreinterpretq_s64_u64(vmull_u32(vget_high_u32(c), vget_high_u32(d))); \
      vst1q_s64(denom + 2, _r);                                                  \
    }                                                                            \
  }
...
void sum_windows_8x4_int_8u_armv7(SUM_WINDOWS_FORMAL_ARGS)
{
  ...
  for (; i + WIN_CHUNK <= numWindows; i += WIN_CHUNK)
  {
    ...
    _r2 = t_1.val[0];
    _r3 = t_1.val[1];
    sum = vreinterpretq_u32_u16(vcombine_u16(vpadd_u16(vget_low_u16(_r2), vget_high_u16(_r2)), vpadd_u16(vget_low_u16(_r3), vget_high_u16(_r3))));
    _r0 = vld1q_u32((const uint32_t *)(pSrc + srcStride));
    _r1 = vld1q_u32((const uint32_t *)(pSrc + srcStride + 4));
    _r0 = vaddq_u32(
        _r0, vld1q_u32((const uint32_t *)(pSrcNext + srcStride)));
...
void sum_windows_8x8_int_8u_armv7(SUM_WINDOWS_FORMAL_ARGS)
{
  ...
  for (; i + WIN_CHUNK <= numWindows; i += WIN_CHUNK)
  {
    ...
    sum = vcombine_u32(vpadd_u32(vget_low_u32(sum), vget_high_u32(sum)), vpadd_u32(vget_low_u32(_r1), vget_high_u32(_r1)));
    ref_sigma_sqd = vcombine_u32(vpadd_u32(vget_low_u32(ref_sigma_sqd), vget_high_u32(ref_sigma_sqd)), vpadd_u32(vget_low_u32(_r2), vget_high_u32(_r2)));
    cmp_sigma_sqd = vcombine_u32(vpadd_u32(vget_low_u32(cmp_sigma_sqd), vget_high_u32(cmp_sigma_sqd)), vpadd_u32(vget_low_u32(_r3), vget_high_u32(_r3)));
    sigma_both = vcombine_u32(vpadd_u32(vget_low_u32(sigma_both), vget_high_u32(sigma_both)), vpadd_u32(vget_low_u32(_r4), vget_high_u32(_r4)));
    pSrc += sizeof(uint32_t) * WIN_SIZE;
    // CALC
    ref_sigma_sqd = vshlq_n_u32(ref_sigma_sqd, 6);
    cmp_sigma_sqd = vshlq_n_u32(cmp_sigma_sqd, 6);
...
{
  sum_windows_16_int_8u_armv7(SUM_WINDOWS_ACTUAL_ARGS);
}
...
void sum_windows_16_int_8u_armv7(SUM_WINDOWS_FORMAL_ARGS)
{
  ...
  for (; i + WIN_CHUNK <= numWindows; i += WIN_CHUNK)
  {
    ...
    for (uint32_t x = 0; x < 16; x += 4)
    {
      ...
      _r1 = vcombine_u32(vpadd_u32(vget_low_u32(_r0), vget_high_u32(_r0)), vpadd_u32(vget_low_u32(_r1), vget_high_u32(_r1)));
      _r3 = vcombine_u32(vpadd_u32(vget_low_u32(_r2), vget_high_u32(_r2)), vpadd_u32(vget_low_u32(_r3), vget_high_u32(_r3)));
      _r1 = vcombine_u32(vpadd_u32(vget_low_u32(_r1), vget_high_u32(_r1)), vpadd_u32(vget_low_u32(_r3), vget_high_u32(_r3)));
      sum = vaddq_u32(sum, _r1);
      _r0 = vld1q_u32(
          (const uint32_t *)(pSrc + (x + 1) * srcStride));
      _r1 = vld1q_u32(
...
{
  sum_windows_8x4_float_8u_armv7(SUM_WINDOWS_ACTUAL_ARGS);
}

void sum_windows_8x8_float_10u_armv7(SUM_WINDOWS_FORMAL_ARGS)
{
  sum_windows_8x8_float_8u_armv7(SUM_WINDOWS_ACTUAL_ARGS);
}

void sum_windows_16x4_float_10u_armv7(SUM_WINDOWS_FORMAL_ARGS)
{
  sum_windows_16_float_10u_armv7(SUM_WINDOWS_ACTUAL_ARGS);
}
...
#define calc_window_ssim_int_10u_armv7()                                                           \
  {                                                                                                \
    /* STEP 2. adjust values */                                                                    \
    uint64_t a_64[2], c_64[2], d_64[2];                                                            \
    int64_t b_64[2];                                                                               \
...
{
  sum_windows_8x4_int_8u_armv7(SUM_WINDOWS_ACTUAL_ARGS);
}

void sum_windows_8x8_int_10u_armv7(SUM_WINDOWS_FORMAL_ARGS)
{
  sum_windows_8x8_int_8u_armv7(SUM_WINDOWS_ACTUAL_ARGS);
}

void sum_windows_16x4_int_10u_armv7(SUM_WINDOWS_FORMAL_ARGS)
{
  sum_windows_16_int_10u_armv7(SUM_WINDOWS_ACTUAL_ARGS);
}
...
void sum_windows_16_int_10u_armv7(SUM_WINDOWS_FORMAL_ARGS)
{
  ...
  for (; i + WIN_CHUNK <= numWindows; i += WIN_CHUNK)
  {
    ...
    for (uint32_t x = 0; x < 16; x += 4)
    {
      _r0 = vld1q_u32((const uint32_t *)(pSrc + x * srcStride));
      _r1 = vld1q_u32((const uint32_t *)(pSrc + windowStride + x * srcStride));
      _r2 = vpaddlq_u32(vcombine_u32(vpadd_u32(vget_low_u32(_r0), vget_high_u32(_r0)), vpadd_u32(vget_low_u32(_r1), vget_high_u32(_r1))));
      ref_sum = vaddq_u64(ref_sum, (vbicq_u64(_r2, fullMSB)));
      cmp_sum = vaddq_u64(cmp_sum, (vshrq_n_u64(_r2, 16)));
      _r0 = vld1q_u32((const uint32_t *)(pSrc + (x + 1) * srcStride));
      _r1 = vld1q_u32((const uint32_t *)(pSrc + windowStride + (x + 1) * srcStride));
    ...
    calc_window_ssim_int_10u_armv7();
